...
const BRANCHES = {
  ...
  fresh_clean: [
    ...
    },
    {
      ...
      cols: 3,
      options: [
        { value: 'bergamot',   emoji: '🍋', label: 'Бергамот' },
        { value: 'grapefruit', emoji: '🍊', label: 'Грейпфрут' },
        { value: 'sea_salt',   emoji: '🌊', label: 'Морская соль' },
        { value: 'white_musk', emoji: '🤍', label: 'Белый мускус' },
        { value: 'green_tea',  emoji: '🍵', label: 'Зелёный чай' },
  ...
  warm_cozy: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'tonka',      emoji: '🫘', label: 'Тонка боб' },
        { value: 'sandalwood', emoji: '🪵', label: 'Сандал' },
        { value: 'cinnamon',   emoji: '🫖', label: 'Корица' },
        { value: 'patchouli',  emoji: '🍂', label: 'Пачули' },
        { value: 'caramel',    emoji: '🍮', label: 'Карамель' },
      ],
    },
    {
      id: 'intensity',
  ...
  dark_sexy: [
    ...
    },
    {
      ...
      cols: 3,
      options: [
        { value: 'rum',          emoji: '🥃', label: 'Ром' },
        { value: 'oud',          emoji: '🪵', label: 'Уд' },
        { value: 'black_pepper', emoji: '🌶️', label: 'Чёрный перец' },
        { value: 'tobacco_note', emoji: '🚬', label: 'Табак' },
        { value: 'incense',      emoji: '🕌', label: 'Ладан' },
        { value: 'vanilla',      emoji: '🍦', label: 'Ваниль' },
      ],
    },
    {
  ...
  elegant_luxury: [
    ...
    },
    {
      ...
      cols: 3,
      options: [
        { value: 'iris',       emoji: '🌸', label: 'Ирис' },
        { value: 'sandalwood', emoji: '🪵', label: 'Сандал' },
        { value: 'vetiver',    emoji: '🌿', label: 'Ветивер' },
        { value: 'amber',      emoji: '🪸', label: 'Амбра' },
        { value: 'white_musk', emoji: '🤍', label: 'Белый мускус' },
        { value: 'neroli',     emoji: '🌿', label: 'Нероли' },
      ],
    },
    {
      id: 'intensity',
  ...
  artistic_niche: [
    ...
    },
    {
      ...
      options: [
        { value: 'oud',          emoji: '🪵', label: 'Уд' },
        { value: 'incense',      emoji: '🕌', label: 'Ладан / инсенс' },
        { value: 'vetiver',      emoji: '🌿', label: 'Ветивер' },
        { value: 'resin',        emoji: '🍯', label: 'Смола / бензоин' },
        { value: 'leather_note', emoji: '🖤', label: 'Кожа' },
        { value: 'iris',         emoji: '🌸', label: 'Ирис' },
      ],
    },
    {
  ...
  soft_skin: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'ambroxan',    emoji: '🪸', label: 'Амброксан' },
        { value: 'cashmeran',   emoji: '☁️', label: 'Кашмеран' },
        { value: 'sandalwood',  emoji: '🪵', label: 'Сандал' },
        { value: 'iris',        emoji: '🌸', label: 'Ирис' },
        { value: 'milky_note',  emoji: '🥛', label: 'Молочные ноты' },
      ],
    },
    {
      id: 'intensity',
